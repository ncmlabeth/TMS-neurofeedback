...
dataFilename = [direc filesep 'data' filesep subCode filesep SesNum filesep 'col_' SessionType num2str(blockNumber) '-m' num2str(nMEPs) '-c' num2str(nChans) '.dat'];
...
%                fwrite(usb,marker); % write marker
    ...
    save([direc filesep 'data' filesep subCode filesep SesNum filesep 'col_' SessionType num2str(blockNumber) '-mep' (num2str(ii)) '.mat'], 'feedbackData');
