...
dataFilename = [direc filesep 'data' filesep subCode filesep 'EEG' filesep 'pre_' SessionType  num2str(FirstOrSecondDay) '-m' num2str(nMEPs) '-c' num2str(nChans) '.dat'];
...
for ii = 1:nMEPs
    ...
    save([direc filesep 'data' filesep subCode filesep 'EEG' filesep 'pre_' SessionType num2str(FirstOrSecondDay) '-mep' (num2str(ii)) '.mat'], 'feedbackData');
