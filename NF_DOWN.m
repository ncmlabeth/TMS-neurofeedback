...
save([direc filesep 'data' filesep subCode filesep SesNum filesep 'DN_b' num2str(blockNumber) '-success' (num2str(nSuccess)) '.mat'], 'nSuccess', 'percentage_success')%save the num of successful trials
