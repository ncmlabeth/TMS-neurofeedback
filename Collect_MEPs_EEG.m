...
nMEPs = 12;  % number of MEPs to collect
...
dataFilename = [direc filesep 'data' filesep subCode filesep 'EEG' filesep 'col_' SessionType num2str(blockNumber) '-m' num2str(nMEPs) '-c' num2str(nChans) '.dat'];
...
for ii = 1:nMEPs
    ...
    save([direc filesep 'data' filesep subCode filesep 'EEG' filesep 'col_' SessionType num2str(blockNumber) '-mep' (num2str(ii)) '.mat'], 'feedbackData');
