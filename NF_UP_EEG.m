...
dataFilename = [direc filesep 'data' filesep subCode filesep 'EEG' filesep 'UP_b'  num2str(blockNumber) '-m' num2str(nMEPs) '-c' num2str(nChans) '.dat'];
...
for ii = 1:nMEPs
    ...
    while exitTrial == false
        ...
        elseif trialState  == 3 && vbl - emgStartTime > emgDuration
            ...
            save([direc filesep 'data' filesep subCode filesep 'EEG' filesep 'exp_UP' num2str(blockNumber) '-mep' (num2str(ii)) '.mat'], 'feedbackData','rawRMSData' )
...
save([direc filesep 'data' filesep subCode filesep 'EEG' filesep 'UP_b' num2str(blockNumber) '-success' (num2str(nSuccess)) '.mat'], 'nSuccess', 'percentage_success')%save the num of successful trials
